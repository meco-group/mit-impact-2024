...
def makeFigures(params, simulation_results):
    time = simulation_results['t_all']
    pos_all = simulation_results['pos_all']
    vel_all = simulation_results['vel_all']
    quat_all = simulation_results['quat_all']
    omega_all = simulation_results['omega_all']
    euler_all = simulation_results['euler_all']
    commands = simulation_results['w_cmd_all']
    wMotor_all = simulation_results['wMotor_all']
    thrust = simulation_results['thr_all']
    torque = simulation_results['tor_all']
    sDes_traj = simulation_results['sDes_traj_all']
    sDes_calc = simulation_results['sDes_calc_all']
